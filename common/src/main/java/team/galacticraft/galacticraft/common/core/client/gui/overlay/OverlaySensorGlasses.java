...
//            final int var7 = var5.getScaledHeight();
            ...
            OverlaySensorGlasses.minecraft.font.draw(I18n.get("gui.sensor.advanced") + ": " + (var2 ? I18n.get("gui.sensor.advancedon") : I18n.get("gui.sensor.advancedoff")), width / 2 - 50, 4, 0x03b88f);
