...
//        {
//            tooltip.add(EnumColor.BRIGHT_GREEN + I18n.get(this.getUnlocalizedName() + "." + ItemBasic.names[par1ItemStack.getDamage()] + ""));
//        }
//        else if (par1ItemStack.getDamage() == 19)
//        {
//            tooltip.add(EnumColor.AQUA + I18n.get("gui.frequency_module.desc.0"));
//            tooltip.add(EnumColor.AQUA + I18n.get("gui.frequency_module.desc.1"));
//        }
//    }
//
//    @Override
