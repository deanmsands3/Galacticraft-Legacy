...
//        {
//            tooltip.add(EnumColor.BRIGHT_GREEN + I18n.get("item.basic_item." + ItemFood.names[par1ItemStack.getDamage()] + ""));
//        }
//        else if (par1ItemStack.getDamage() == 8)
//        {
//            tooltip.add(EnumColor.BRIGHT_GREEN + I18n.get("item.food.cheeseburger.desc"));
//        }
//    }
//
//    @Override
