...
//            {
//                this.generateCaveNode(random.nextLong(), par3, par4, primer, par6, par8, par10, random.nextFloat() * 0.5F + 0.5F, par13 - Constants.HALF_PI, par14 / 3.0F, par15, par16, 1.0D);
//                this.generateCaveNode(random.nextLong(), par3, par4, primer, par6, par8, par10, random.nextFloat() * 0.5F + 0.5F, par13 + Constants.HALF_PI, par14 / 3.0F, par15, par16, 1.0D);
//                return;
//            }
//
...
//            {
//                final float var17 = this.rand.nextFloat() * Constants.TWO_PI;
