...
//        this.averageGroundLevel = Math.max(par4StructureBoundingBox.imageWidth, par4StructureBoundingBox.getZSize());
//    }
//
//    @Override
...
//            if (var6 != null)
//            {
//                var5 += Math.max(var6.getBoundingBox().imageWidth, var6.getBoundingBox().getZSize());
//                var4 = true;
//            }
//        }
//
