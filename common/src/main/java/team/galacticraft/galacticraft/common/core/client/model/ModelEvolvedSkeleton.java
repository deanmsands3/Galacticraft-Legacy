...
//            this.bipedRightArm.rotateAngleX = -(Constants.HALF_PI) + this.bipedHead.rotateAngleX;
//            this.bipedLeftArm.rotateAngleX = -(Constants.HALF_PI) + this.bipedHead.rotateAngleX;
