...
public class ModelEvolvedSpider extends EntityModel<EntityEvolvedSpider>
{
    ...
    public void setRotationAngles(EntityEvolvedSpider entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        final float var12 = -(Mth.cos(limbSwing * 0.6662F * 2.0F + Constants.HALF_PI) * 0.4F) * limbSwingAmount;
        final float var13 = -(Mth.cos(limbSwing * 0.6662F * 2.0F + 3F * Constants.HALF_PI) * 0.4F) * limbSwingAmount;
        ...
        final float var16 = Math.abs(Mth.sin(limbSwing * 0.6662F + Constants.HALF_PI) * 0.4F) * limbSwingAmount;
        final float var17 = Math.abs(Mth.sin(limbSwing * 0.6662F + 3F * Constants.HALF_PI) * 0.4F) * limbSwingAmount;
