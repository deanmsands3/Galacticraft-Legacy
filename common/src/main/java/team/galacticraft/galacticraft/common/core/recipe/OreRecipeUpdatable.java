...
////    public OreRecipeUpdatable(ResourceLocation group, @NotNull ItemStack result, Object... recipe) { super(group, result, CraftingHelper.parseShaped(recipe)); }
////    public OreRecipeUpdatable(ResourceLocation group, @NotNull ItemStack result, ShapedPrimer primer){ super (group, result, primer); }
//
//
