package team.galacticraft.galacticraft.common.api;
...
public class GalacticraftRegistry
{
     ...
     * left-EnvType of the screen while the player is in the rocket.
     *
...
//        return type;
//    } TODO ?
//    public static DimensionType getTypeID(int index)
//    {
