...
public class EntityCelestialFake extends EntityAdvancedMotion implements IIgnoreShift
{
    ...
    public EntityCelestialFake(EntityType<EntityCelestialFake> type, Level world)
    {
        super(type, world);
    }

    public EntityCelestialFake(Level var1, double var2, double var4, double var6)
    {
        this(GCEntities.CELESTIAL_FAKE, var1);
        this.setPos(var2, var4, var6);
    }

    public EntityCelestialFake(ServerPlayer player)
    {
