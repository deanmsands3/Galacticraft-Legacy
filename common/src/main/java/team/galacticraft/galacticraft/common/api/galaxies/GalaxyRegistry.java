...
public class GalaxyRegistry
{
    ...
    public static final Event<SolarSystemRegisterCallback> SOLAR_SYSTEM_REGISTER_EVENT = EventFactory.createLoop(SolarSystemRegisterCallback.class);
    public static final Event<PlanetRegisterCallback> PLANET_REGISTER_EVENT = EventFactory.createLoop(PlanetRegisterCallback.class);
    public static final Event<MoonRegisterCallback> MOON_REGISTER_EVENT = EventFactory.createLoop(MoonRegisterCallback.class);
    public static final Event<SatelliteRegisterCallback> SATELLITE_REGISTER_EVENT = EventFactory.createLoop(SatelliteRegisterCallback.class);
    ...
    public static CelestialBody getCelestialBodyFromDimensionID(DimensionType dimensionID)
    {
        ...
        {
            if (satellite.getType() == dimensionID)
            {
                return satellite;
            }
        }
    ...
    public static boolean registerSolarSystem(SolarSystem solarSystem)
    {
        ...
        SOLAR_SYSTEM_REGISTER_EVENT.invoker().invoke(solarSystem.getName(), GalaxyRegistry.maxSolarSystemID);
        return true;
    }
    ...
    public static boolean registerPlanet(Planet planet)
    {
        ...
        PLANET_REGISTER_EVENT.invoker().invoke(planet.getName(), GalaxyRegistry.maxPlanetID);
        return true;
    }
    ...
    public static boolean registerMoon(Moon moon)
    {
        ...
        MOON_REGISTER_EVENT.invoker().invoke(moon.getName(), GalaxyRegistry.maxMoonID);
        return true;
    }
    ...
    @FunctionalInterface
    public interface SolarSystemRegisterCallback
    {
        void invoke(String solarSystemName, int solarSystemID);
    }

    @FunctionalInterface
    public interface PlanetRegisterCallback
    {
        void invoke(String planetName, int planetID);
    }

    @FunctionalInterface
    public interface MoonRegisterCallback
    {
        void invoke(String moonName, int moonID);
    }

    @FunctionalInterface
    public interface SatelliteRegisterCallback
    {
        void invoke(String satelliteName, int satelliteID);
    }
}
