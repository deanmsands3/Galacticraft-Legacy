package team.galacticraft.galacticraft.common.api.inventory;
...
public class AccessInventoryGC
{
    ...
    public static IInventoryGC getGCInventoryForPlayer(ServerPlayer player)
    {
        try
        {
            ...
            {
                playerStatsClass = Class.forName("team.galacticraft.galacticraft.common.core.entities.player.GCPlayerStats");
