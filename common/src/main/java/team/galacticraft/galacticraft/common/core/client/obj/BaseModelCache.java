...
public class BaseModelCache {
    ...
    public static class ModelData {
        ...
        public BakedModel bake(IModelConfiguration config) {
            return bakedMap.computeIfAbsent(config, c -> model.bake(c, ModelLoader.instance(), ModelLoader.defaultTextureGetter(), SimpleModelTransform.IDENTITY, ModelItemPropertyOverrideList.EMPTY, rl));
        }
