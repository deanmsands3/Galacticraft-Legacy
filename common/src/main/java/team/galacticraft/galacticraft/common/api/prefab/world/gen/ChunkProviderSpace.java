...
//        catch (Exception e)
//        {
//            PlatformSpecific.getLogger().severe("Error caught in planetary worldgen at coords " + x + "," + z + ".  If the next 2 lines are showing an Add-On mod name, please report to that mod's author!");
//            e.printStackTrace();
//        }
//
