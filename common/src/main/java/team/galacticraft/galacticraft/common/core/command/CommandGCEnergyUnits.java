...
//            }
//
//            throw new WrongUsageException(I18n.getWithFormat("commands.gcenergyunits.invalid_units", this.getUsage(sender)), new Object[0]);
//        }
//
//        throw new WrongUsageException(I18n.getWithFormat("commands.gcenergyunits.no_units", this.getUsage(sender)), new Object[0]);
//    }
//
//
