...
//        mc.entityRenderer.setupOverlayRendering(); TODO Needed?
        ...
        if (mc.player.getVehicle() instanceof EntityAutoRocket)
        {
            ...
            if (rocket.launchPhase == EnumLaunchPhase.LANDING.ordinal() && rocket.targetVec != null)
            {
                ...
                String targetMotionYStr = I18n.get("gui.docking_rocket.target_vel") + ": " + String.format("%.2f", targetMotionY);
                String currentMotionYStr = I18n.get("gui.docking_rocket.current_vel") + ": " + String.format("%.2f", currentMotionY);
...
//                if (dMY > 25)
//                {
//                    String warning = I18n.getWithFormat("gui.docking_rocket.warning.name.0", GameSettings.getKeymessage(KeyHandlerClient.spaceKey.getKeyCode()));
//                    mc.fontRenderer.drawString(warning, width / 2 - mc.fontRenderer.getStringWidth(warning) / 2, height / 3 - 50, green);
//                }
//                else if (dMY < -25)
//                {
//                    String warning2 = I18n.getWithFormat("gui.docking_rocket.warning.name.1", GameSettings.getKeymessage(KeyHandlerClient.leftShiftKey.getKeyCode()));
...
//                }
                ...
                mc.font.draw(I18n.get("gui.docking_rocket.distance_from"), 50, height / 3.0F + 15, grey);
