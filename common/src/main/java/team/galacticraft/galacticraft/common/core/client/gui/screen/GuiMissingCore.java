...
public class GuiMissingCore extends Screen
{
    ...
    public void render(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.font, I18n.get("gui.missing_core.name.0"), this.width / 2, offset, 0xFF5555);
        offset += 25;
        this.drawCenteredString(this.font, I18n.get("gui.missing_core.name.1"), this.width / 2, offset, 0xFF5555);
        offset += 20;
        this.drawCenteredString(this.font, I18n.get("gui.missing_core.name.2"), this.width / 2, offset, 0x999999);
        offset += 20;
        String s = ChatFormatting.UNDERLINE + I18n.get("gui.missing_core.name.3");
