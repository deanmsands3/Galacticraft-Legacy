...
public class FluidUtil
{
    ...
    public static boolean isFuelContainerAny(ItemStack var4)
    {
        ...
        {
            return var4.getItem() == GCItems.fuelCanister && var4.getDamageValue() < var4.getMaxDamage();
        }
...
//        return false;
    ...
    public static boolean isOilContainerAny(ItemStack var4)
    {
        if (var4.getItem() instanceof ItemCanisterGeneric)
        {
            return var4.getItem() == GCItems.oilCanister && var4.getDamageValue() < var4.getMaxDamage();
        }
...
//        } TODO Bucket
    ...
    public static int getContainerCapacity(ItemStack container)
    {
        ...
        if (!container.isEmpty())
        {
            ...
            {
                FluidStack drain = fluidHandler.orElse(null).drain(Integer.MAX_VALUE, ActionType.SIMULATE);
...
//        } TODO Bucket
    ...
    @NotNull
    public static FluidActionResult interactWithFluidHandler(@NotNull ItemStack container, IFluidHandler fluidHandler, Player player)
    {
