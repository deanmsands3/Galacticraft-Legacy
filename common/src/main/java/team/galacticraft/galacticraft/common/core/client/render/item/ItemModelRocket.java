...
public class ItemModelRocket extends ModelTransformWrapper
{
    ...
    protected boolean getTransformForPerspective(TransformType cameraTransformType, PoseStack mat)
    {
        ...
        if (cameraTransformType == TransformType.FIRST_PERSON_RIGHT_HAND || cameraTransformType == TransformType.FIRST_PERSON_LEFT_HAND)
        {
            ...
            mat.mulPose(new Quaternion(Constants.HALF_PI, 0.0F, 0.0F, false));
        ...
        if (cameraTransformType == TransformType.THIRD_PERSON_RIGHT_HAND || cameraTransformType == TransformType.THIRD_PERSON_LEFT_HAND)
        {
            ...
            mat.scale(0.5F, 0.5F, 0.5F);
            mat.mulPose(new Quaternion(0.0F, 0.0F, -Constants.HALF_PI, false));
            mat.mulPose(new Quaternion(0.0F, Constants.HALF_PI, 0.0F, false));
