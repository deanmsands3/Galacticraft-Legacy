...
public class EntityEvolvedZombie extends Zombie implements IEntityBreathable, ITumblable
{
    private static final EntityDataAccessor<Float> SPIN_PITCH = SynchedEntityData.defineId(EntityEvolvedZombie.class, EntityDataSerializers.FLOAT);
    private final int conversionTime = 0;
    private float tumbling = 0F;
    private float tumbleAngle = 0F;

    public EntityEvolvedZombie(EntityType<? extends EntityEvolvedZombie> type, Level worldIn)
    {
        super(type, worldIn);
    }
