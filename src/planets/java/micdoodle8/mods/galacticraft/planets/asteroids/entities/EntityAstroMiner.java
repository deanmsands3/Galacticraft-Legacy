...
import micdoodle8.mods.galacticraft.network.IPacketReceiver;
import micdoodle8.mods.galacticraft.network.PacketDynamic;
...
import micdoodle8.mods.galacticraft.util.RecipeUtil;
...
public class EntityAstroMiner extends Entity implements IInventory, IPacketReceiver, IEntityNoisy, IAntiGrav, ITelemetry
{
    ...
    private final int MAXENERGY = 12000;
    private final int RETURNENERGY = 1000;
    private final int RETURNDROPS = 10;
    private final int INV_SIZE = 227;
    private final float cLENGTH = 2.6F;
    private final float cWIDTH = 1.8F;
    private final float cHEIGHT = 1.7F;
    private final double SPEEDUP = 2.5D;
...
//        this.dataManager.addObject(this.timeSinceHit, new Integer(0));
    ...
    public void onUpdate()
    {
        ...
        case AISTATE_DOCKING:
            ...
            {
                GCLog.warn("AstroMiner missing base position: this is a bug.");
...
*/
    ...
    private boolean moveToTarget()
    {
        ...
        if (this.posTarget == null)
        {
            GCLog.warn("AstroMiner missing target: this is a bug.");
    ...
    private ItemStack getGTDrops(World w, BlockPos pos, Block b)
    {
    	...
    	b.getDrops(ret, w, pos, b.getDefaultState(), 1);
    ...
    private ItemStack getPickBlock(World world, BlockPos pos, Block b)
    {
        ...
        {
        	NonNullList<ItemStack> ret = NonNullList.create();
        	b.getDrops(ret, world, pos, b.getDefaultState(), 0);
            return ret.get(0);
        }
    ...
    public static boolean spawnMinerAtBase(World world, int x, int y, int z, EnumFacing facing, BlockVec3 base, EntityPlayerMP player)
    {
        ...
        final EntityAstroMiner miner = new EntityAstroMiner(world, NonNullList.withSize(227, ItemStack.EMPTY), 0);
        ...
        miner.speedup = (world.provider instanceof WorldProviderAsteroids) ? 2.5D * 2.2D : 2.5D;
