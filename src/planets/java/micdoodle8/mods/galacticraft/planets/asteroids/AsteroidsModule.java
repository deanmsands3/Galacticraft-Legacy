...
import micdoodle8.mods.galacticraft.command.CommandGCAstroMiner;
...
public class AsteroidsModule implements IPlanetsModule
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        AsteroidItems.initItems();

        AsteroidsModule.planetAsteroids.setBiomeInfo(GCPlanetsBiomes.ASTEROIDS);
        //This enables Endermen on Asteroids in Asteroids Challenge mode
        ((BiomeAsteroids)GCPlanetsBiomes.ASTEROIDS).resetMonsterListByMode(ConfigManagerCore.challengeMobDropsAndSpawning);
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        AsteroidItems.oreDictRegistrations();
