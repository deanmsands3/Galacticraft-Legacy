...
import micdoodle8.mods.galacticraft.blocks.BlockMulti.EnumBlockMultiType;
...
public class TileEntityMinerBase extends TileBaseElectricBlockWithInventory implements ISidedInventory, IMultiBlock, IMachineSides
{
    ...
    public static void checkNewMinerBases()
    {
        ...
        while (entries.hasNext())
        {
            ...
            if (w == null)
            {
                GCLog.warn("Astro Miner Base placement: Unable to find server world for dim " + entry.getKey());
                entries.remove();
                continue;
            }
