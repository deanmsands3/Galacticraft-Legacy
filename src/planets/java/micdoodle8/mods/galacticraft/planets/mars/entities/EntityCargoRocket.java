    ...
    public void onReachAtmosphere()
    {
        ...
        if (this.targetVec != null)
        {
            ...
            if (this.targetDimension != GCCoreUtil.getDimensionID(this.world))
            {
                ...
                World targetWorld = DimensionManager.getWorld(this.targetDimension);
                if (targetWorld != null && targetWorld instanceof WorldServer)
                {
                    ...
                    Entity e = WorldUtil.transferEntityToDimension(this, this.targetDimension, (WorldServer) targetWorld, false, null);
