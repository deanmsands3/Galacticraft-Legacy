...
public class VenusModule implements IPlanetsModule
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        VenusModule.planetVenus.setBiomeInfo(GCPlanetsBiomes.VENUS, GCPlanetsBiomes.VENUS_MOUNTAIN, GCPlanetsBiomes.VENUS_VALLEY);
    }
    ...
    {
        registerTileEntity(TileEntitySpout.class, "GC Venus Spout");
        registerTileEntity(TileEntityDungeonSpawnerVenus.class, "GC Venus Dungeon Spawner");
        registerTileEntity(TileEntityTreasureChestVenus.class, "GC Tier 3 Treasure Chest");
        registerTileEntity(TileEntityGeothermalGenerator.class, "GC Geothermal Generator");
        registerTileEntity(TileEntityCrashedProbe.class, "GC Crashed Probe");
        registerTileEntity(TileEntitySolarArrayModule.class, "GC Solar Array Module");
        registerTileEntity(TileEntitySolarArrayController.class, "GC Solar Array Controller");
        registerTileEntity(TileEntityLaserTurret.class, "GC Laser Turret");
    }
