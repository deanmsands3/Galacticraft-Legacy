...
import micdoodle8.mods.galacticraft.world.gen.EnumCraterSize;
...
//                                arrayOfMeta[index] = var15m;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            GCLog.warn("Error caught in planetary worldgen at coords " + x + "," + z + ".  If the next 2 lines are showing an Add-On mod name, please report to that mod's author!");
            e.printStackTrace();
        }
