...
public abstract class CelestialBody implements Comparable<CelestialBody>
{
    ...
    protected boolean forceStaticLoad = false;
    ...
    public GalacticraftBiome[] biomesToAdapt;
    ...
    public void setBiomeInfo(Biome ...  biomes)
    {
        ...
        LinkedList<GalacticraftBiome> adaptiveBiomes = new LinkedList<>();
        int index = 0;
        for (Biome b : biomes)
        {
            this.biomeInfo.add(b);
            if (b instanceof GalacticraftBiome && ((GalacticraftBiome)b).isAdaptiveBiome)
            {
                this.biomesToGenerate.add(BiomeAdaptive.register(index++, (GalacticraftBiome) b));
                adaptiveBiomes.add((GalacticraftBiome) b);
            }
            else
            {
        ...
        this.biomesToAdapt = adaptiveBiomes.toArray(new GalacticraftBiome[adaptiveBiomes.size()]);
    }
