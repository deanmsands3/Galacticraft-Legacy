...
import micdoodle8.mods.galacticraft.entities.player.EnumGravity;
...
import static micdoodle8.mods.galacticraft.proxy.ClientProxyCore.PLAYER_Y_OFFSET;
import static micdoodle8.mods.galacticraft.proxy.ClientProxyCore.submergedTextures;
...
public class TransformerHooks
{
    ...
    public static void otherModGenerate(int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
    {
        ...
        if (!(world.provider instanceof IGalacticraftWorldProvider) || ConfigManagerCore.enableOtherModsFeatures)
        {
            ...
            {
                GCLog.warn("Error in another mod's worldgen.  This is *NOT* a Galacticraft bug, report it to the other mod please.");
                GCLog.warn("Details:- Dimension:" + GCCoreUtil.getDimensionID(world) + "  Chunk cx,cz:" + chunkX + "," + chunkZ + "  Seed:" + world.getSeed());
                e.printStackTrace();
            }
            return;
        }
