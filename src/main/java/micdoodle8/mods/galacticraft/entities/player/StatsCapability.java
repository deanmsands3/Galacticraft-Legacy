...
import micdoodle8.mods.galacticraft.command.CommandGCInv;
import micdoodle8.mods.galacticraft.init.GCBlocks;
import micdoodle8.mods.galacticraft.inventory.InventoryExtended;
import micdoodle8.mods.galacticraft.tile.TileEntityPanelLight;
...
public class StatsCapability extends GCPlayerStats
{
    ...
    public void loadNBTData(NBTTagCompound nbt)
    {
        ...
        {
            GCLog.warn("Found error in saved Galacticraft player data for " + PlayerUtil.getName(player.get()) + " - this should fix itself next relog.");
            e.printStackTrace();
        }
