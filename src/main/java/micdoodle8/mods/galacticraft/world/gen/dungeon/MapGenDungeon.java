package micdoodle8.mods.galacticraft.world.gen.dungeon;
...
public class MapGenDungeon extends MapGenStructure
{
    ...
    public static class Start extends StructureStart
    {
        ...
        public void generateStructure(World worldIn, Random rand, StructureBoundingBox structurebb) {
            if (CompatibilityManager.spongeLoaded)
            {
                ...
                while (iterator.hasNext())
                {
                    ...
                    if (!structurecomponent.addComponentParts(worldIn, rand, structurebb))
                    {
                        iterator.remove();
                    }
                }
