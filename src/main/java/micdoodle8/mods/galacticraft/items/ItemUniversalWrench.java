...
import micdoodle8.mods.galacticraft.blocks.BlockAdvanced;
import micdoodle8.mods.galacticraft.energy.tile.TileBaseUniversalElectrical;
...
public class ItemUniversalWrench extends Item implements ISortableItem
{
    ...
    @Annotations.RuntimeInterface(clazz = "buildcraft.api.tools.IToolWrench", modID = "buildcraftcore")
