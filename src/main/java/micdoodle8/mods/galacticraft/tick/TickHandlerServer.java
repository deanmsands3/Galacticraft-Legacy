...
import micdoodle8.mods.galacticraft.blocks.BlockUnlitTorch;
import micdoodle8.mods.galacticraft.command.CommandGCHouston;
import micdoodle8.mods.galacticraft.dimension.SpaceRace;
import micdoodle8.mods.galacticraft.dimension.SpaceRaceManager;
import micdoodle8.mods.galacticraft.dimension.WorldDataSpaceRaces;
import micdoodle8.mods.galacticraft.energy.grid.EnergyNetwork;
import micdoodle8.mods.galacticraft.energy.tile.TileBaseConductor;
import micdoodle8.mods.galacticraft.entities.player.GCPlayerStats;
import micdoodle8.mods.galacticraft.fluid.FluidNetwork;
import micdoodle8.mods.galacticraft.fluid.ThreadFindSeal;
...
import micdoodle8.mods.galacticraft.tile.TileEntityFluidTank;
import micdoodle8.mods.galacticraft.tile.TileEntityFluidTransmitter;
import micdoodle8.mods.galacticraft.tile.TileEntityOxygenSealer;
import micdoodle8.mods.galacticraft.tile.TileEntityPainter;
...
import micdoodle8.mods.galacticraft.wrappers.ScheduledBlockChange;
        ...
        if (event.phase == Phase.START)
        {
            ...
            for (ScheduledDimensionChange change : TickHandlerServer.scheduledDimensionChanges)
            {
                try
                {
                    ...
                    {
                        GCLog.warn("World not found when attempting to transfer entity to dimension: " + change.getDimensionId());
                    }
                ...
                {
                    GCLog.warn("Error occurred when attempting to transfer entity to dimension: " + change.getDimensionId());
                    e.printStackTrace();
                }
            }
            ...
            if (tickCount % 20 == 0)
            {
                if (!playersRequestingMapData.isEmpty())
                {
                    ...
                    if (!baseFolder.exists() && !baseFolder.mkdirs())
                    {
                        ...
                        GCLog.warn("Base folder(s) could not be created: " + baseFolder.getAbsolutePath());
                    }
                    else
                    {
