...
//    private static boolean clientConnected = false;
    ...
    static
    {
        ConnectionProtocol.PROTOCOL_BY_PACKET.put(PacketSimple.class, ConnectionProtocol.PLAY);
        registerPacket(PacketFlow.CLIENTBOUND, PacketSimple.class, PacketSimple::new);
    }

    protected static <P extends Packet<?>> void registerPacket(PacketFlow direction, Class<P> clazz, Supplier<P> supplier)
    {
        Object o = ConnectionProtocol.PLAY.flows.get(direction);
        Class<? extends ConnectionProtocol> outerClass = ConnectionProtocol.PLAY.getClass();
