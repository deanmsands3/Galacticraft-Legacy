...
public class MeteorModel extends EntityModel<MeteorEntity>
{
    ...
    @Override
    public void setRotationAngles(MeteorEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    }
    ...
    public void render(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha)
    {
        ...
        {
            shape.render(matrixStack, buffer, packedLight, packedOverlay);
        }
    }
