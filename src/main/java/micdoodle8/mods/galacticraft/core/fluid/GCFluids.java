...
public class GCFluids
{
    ...
    public static final FluidRegistrationEntry<Source, Flowing, FlowingFluidBlock, BucketItem> OXYGEN = registerLiquid("oxygen", "oxygen_gas", "oxygen_gas", fluidAttributes -> fluidAttributes.color(0xFF6CE2FF).temperature(1).density(13).viscosity(295).gaseous());
    public static final FluidRegistrationEntry<Source, Flowing, FlowingFluidBlock, BucketItem> HYDROGEN = registerLiquid("hydrogen", "hydrogen_gas", "hydrogen_gas", fluidAttributes -> fluidAttributes.color(0xFFFFFFFF).temperature(1).density(1).viscosity(295).gaseous());
