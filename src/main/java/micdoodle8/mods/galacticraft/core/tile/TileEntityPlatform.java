...
public class TileEntityPlatform extends TileEntity implements ITickableTileEntity
{
    ...
    private void updateClient()
    {
        ...
        if (b.getBlock() == GCBlocks.HYDRAULIC_PLATFORM && b.get(BlockPlatform.CORNER) == BlockPlatform.EnumCorner.NW)
        {
    ...
    private int checkCorner(BlockPos blockPos, EnumCorner corner)
    {
        ...
        if (b.getBlock() == GCBlocks.HYDRAULIC_PLATFORM && b.get(BlockPlatform.CORNER) == corner)
        {
    ...
    {
        this.corner = corner;
        this.world.setBlockState(this.getPos(), GCBlocks.HYDRAULIC_PLATFORM.getDefaultState().with(BlockPlatform.CORNER, corner));
    }
    ...
    private void resetBlocks()
    {
        ...
        {
            if (this.world.isBlockLoaded(pos) && this.world.getBlockState(pos).getBlock() == GCBlocks.HYDRAULIC_PLATFORM)
            {
    ...
    private boolean checkIntact()
    {
        ...
        if (bs.getBlock() != GCBlocks.HYDRAULIC_PLATFORM || bs.get(BlockPlatform.CORNER) != this.corner)
        {
            this.resetBlocks();
            return false;
        }
    ...
    private int checkState(BlockPos blockPos, EnumCorner corner)
    {
        ...
        if (bs.getBlock() == GCBlocks.HYDRAULIC_PLATFORM && bs.get(BlockPlatform.CORNER) == corner)
        {
