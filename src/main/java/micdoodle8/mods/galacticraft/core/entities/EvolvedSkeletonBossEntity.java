...
public class EvolvedSkeletonBossEntity extends EntityBossBase implements IEntityBreathable, IRangedAttackMob, IIgnoreShift
{
    ...
    public EvolvedSkeletonBossEntity(EntityType<? extends EvolvedSkeletonBossEntity> type, World worldIn)
    {
        super(type, worldIn);
    ...
    public static EvolvedSkeletonBossEntity create(World world)
    {
