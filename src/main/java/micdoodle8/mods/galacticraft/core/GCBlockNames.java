...
public class GCBlockNames
{
    ...
    public static final String CONCEALED_REPEATER = "concealed_repeater";
    ...
    public static final String UNLIT_TORCH_LIT = "unlit_torch_lit";
    public static final String WALL_UNLIT_TORCH = "wall_unlit_torch";
    public static final String WALL_UNLIT_TORCH_LIT = "wall_unlit_torch_lit";
    ...
    public static final String CONCEALED_REDSTONE = "concealed_redstone";
    ...
    public static final String BUGGY_PAD = "buggy_pad";
