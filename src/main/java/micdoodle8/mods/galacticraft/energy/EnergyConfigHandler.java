package micdoodle8.mods.galacticraft.energy;
...
public class EnergyConfigHandler
{
    ...
    private static void initialiseRF()
    {
        ...
        {
            GCLog.warn("Incomplete Redstone Flux API detected: Galacticraft will not support RF energy connections until this is fixed.");
        }
    }
