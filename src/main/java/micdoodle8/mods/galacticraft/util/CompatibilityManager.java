...
public class CompatibilityManager
{
    ...
    public static boolean modICClassicLoaded = Loader.isModLoaded("ic2-classic-spmod");
    public static boolean modBCraftLoaded = Loader.isModLoaded("buildcraftcore");
	public static boolean modBCraftEnergyLoaded = Loader.isModLoaded("buildcraftenergy");
    public static boolean modBCraftTransportLoaded = Loader.isModLoaded("buildcrafttransport");;
    public static boolean modGTLoaded;
    public static boolean modTELoaded = Loader.isModLoaded("thermalexpansion");
    public static boolean modMekLoaded = Loader.isModLoaded("mekanism");
    public static boolean modAetherIILoaded;
    public static boolean modBasicComponentsLoaded;
    public static boolean modAppEngLoaded;
    public static boolean modPneumaticCraftLoaded;
    public static boolean modBOPLoaded = Loader.isModLoaded("biomesoplenty");
    public static boolean modEIOLoaded = Loader.isModLoaded("enderio");
    public static boolean modAALoaded = Loader.isModLoaded("actuallyadditions");
    public static boolean spongeLoaded = Loader.isModLoaded("spongeforge");
    public static boolean modMatterOverdriveLoaded;
