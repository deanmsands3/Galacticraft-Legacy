...
import micdoodle8.mods.galacticraft.advancement.GCTriggers;
import micdoodle8.mods.galacticraft.blocks.BlockGrating;
import micdoodle8.mods.galacticraft.client.gui.GuiHandler;
import micdoodle8.mods.galacticraft.client.screen.GameScreenBasic;
import micdoodle8.mods.galacticraft.client.screen.GameScreenCelestial;
import micdoodle8.mods.galacticraft.client.screen.GameScreenText;
import micdoodle8.mods.galacticraft.client.sounds.GCSounds;
import micdoodle8.mods.galacticraft.command.*;
import micdoodle8.mods.galacticraft.dimension.*;
import micdoodle8.mods.galacticraft.energy.EnergyConfigHandler;
import micdoodle8.mods.galacticraft.energy.grid.ChunkPowerHandler;
import micdoodle8.mods.galacticraft.energy.tile.TileCableIC2Sealed;
import micdoodle8.mods.galacticraft.entities.*;
import micdoodle8.mods.galacticraft.entities.player.GCCapabilities;
import micdoodle8.mods.galacticraft.entities.player.GCPlayerBaseMP;
import micdoodle8.mods.galacticraft.entities.player.GCPlayerHandler;
import micdoodle8.mods.galacticraft.event.EventHandlerGC;
import micdoodle8.mods.galacticraft.event.LootHandlerGC;
import micdoodle8.mods.galacticraft.init.GCBlocks;
import micdoodle8.mods.galacticraft.init.GCFluids;
import micdoodle8.mods.galacticraft.init.GCItems;
import micdoodle8.mods.galacticraft.items.ItemSchematic;
import micdoodle8.mods.galacticraft.network.ConnectionEvents;
import micdoodle8.mods.galacticraft.network.ConnectionPacket;
import micdoodle8.mods.galacticraft.network.GalacticraftChannelHandler;
import micdoodle8.mods.galacticraft.proxy.CommonProxyCore;
import micdoodle8.mods.galacticraft.recipe.RecipeManagerGC;
import micdoodle8.mods.galacticraft.schematic.SchematicAdd;
import micdoodle8.mods.galacticraft.schematic.SchematicMoonBuggy;
import micdoodle8.mods.galacticraft.schematic.SchematicRocketT1;
import micdoodle8.mods.galacticraft.tick.TickHandlerServer;
import micdoodle8.mods.galacticraft.tile.*;
import micdoodle8.mods.galacticraft.util.*;
import micdoodle8.mods.galacticraft.world.ChunkLoadingCallback;
...
import micdoodle8.mods.galacticraft.world.gen.OreGenOtherMods;
import micdoodle8.mods.galacticraft.world.gen.OverworldGenerator;
...
@Mod(modid = Constants.MOD_ID_CORE, name = GalacticraftCore.NAME, version = Constants.COMBINEDVERSION, useMetadata = true, acceptedMinecraftVersions = Constants.MCVERSION, dependencies = Constants.DEPENDENCIES_FORGE + Constants.DEPENDENCIES_MICCORE + Constants.DEPENDENCIES_MODS, guiFactory = "micdoodle8.mods.galacticraft.client.gui.screen.ConfigGuiFactoryCore")
public class GalacticraftCore
{
    public static final String NAME = "Galacticraft Core";
    private File GCCoreSource;

    @SidedProxy(clientSide = "micdoodle8.mods.galacticraft.proxy.ClientProxyCore", serverSide = "micdoodle8.mods.galacticraft.proxy.CommonProxyCore")
    ...
    public static LinkedList<GalacticraftBiome> biomesList = new LinkedList<>();
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        GalacticraftCore.satelliteSpaceStation.setBiomeInfo(GCBiomes.ORBIT);
        GalacticraftCore.moonMoon.setBiomeInfo(GCBiomes.MOON);
    }
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        {
            GCLog.warn("Failed to register space station dimension type with ID " + ConfigManagerCore.idDimensionOverworldOrbit);
        }
        ...
        {
            GCLog.warn("Failed to register space station dimension type with ID " + ConfigManagerCore.idDimensionOverworldOrbitStatic);
        }
...
//        }
    ...
    public void postInit(FMLPostInitializationEvent event)
    {
        ...
        for (CelestialBody body : cBodyList)
        {
            if (body.shouldAutoRegister())
            {
                ...
                {
                    body.setUnreachable();
                    GCLog.warn("Tried to register dimension for body: " + body.getUnlocalizedName() + " hit conflict with ID " + body.getDimensionID());
                }
            }
        ...
        {
        	GCLog.warn("Error initialising JPEG compressor - this is likely caused by OpenJDK - see https://wiki.micdoodle8.com/wiki/Compatibility#For_clients_running_OpenJDK");
        	e.printStackTrace();
        }
    ...
    public static class RegistrationHandler
    {
        ...
        public static void registerBiomes(RegistryEvent.Register<Biome> event)
        {
            ...
            for (GalacticraftBiome biome : GalacticraftCore.biomesList)
            {
