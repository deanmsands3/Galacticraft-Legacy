...
{
    public EntityTier2Rocket(EntityType<? extends EntityTier2Rocket> type, Level worldIn)
    {
        super(type, worldIn);
//        this.setSize(1.2F, 4.5F);
    }

    public static EntityTier2Rocket createEntityTier2Rocket(Level world, double x, double y, double z, EnumRocketType rocketType)
    {
...
//        rocket.setSize(1.2F, 4.5F);
    ...
    public EntityTier2Rocket createEntityTier2Rocket(Level par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, NonNullList<ItemStack> inv)
    {
