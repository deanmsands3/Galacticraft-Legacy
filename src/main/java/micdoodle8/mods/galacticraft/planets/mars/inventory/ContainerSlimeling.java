...
public class ContainerSlimeling extends AbstractContainerMenu
{
    ...
    public ContainerSlimeling(int containerId, Inventory playerInv, EntitySlimeling slimeling)
    {
    ...
    public static void addSlots(ContainerSlimeling container, Inventory playerInventory, EntitySlimeling slimeling)
    {
