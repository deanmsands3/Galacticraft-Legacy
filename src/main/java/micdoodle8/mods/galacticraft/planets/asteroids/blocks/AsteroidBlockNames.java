...
public class AsteroidBlockNames
{
    ...
    public static final String SHORT_RANGE_TELEPAD_DUMMY = "short_range_telepad_dummy";
    public static final String DARK_ASTEROID_ROCK = "dark_asteroid_rock";
    public static final String GRAY_ASTEROID_ROCK = "gray_asteroid_rock";
    public static final String LIGHT_GRAY_ASTEROID_ROCK = "light_gray_asteroid_rock";
