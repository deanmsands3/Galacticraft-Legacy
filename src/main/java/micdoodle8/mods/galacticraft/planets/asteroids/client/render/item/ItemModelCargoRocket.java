...
{
    public ItemModelCargoRocket(BakedModel modelToWrap)
    {
        super(modelToWrap);
    }
    ...
    protected boolean getTransformForPerspective(ItemTransforms.TransformType cameraTransformType, PoseStack mat)
    {
        ...
        if (cameraTransformType == ItemTransforms.TransformType.FIRST_PERSON_RIGHT_HAND || cameraTransformType == ItemTransforms.TransformType.FIRST_PERSON_LEFT_HAND)
        {
            mat.pushPose();
            mat.mulPose(new Quaternion(0.0F, 45.0F, 0.0F, true));
        ...
        if (cameraTransformType == ItemTransforms.TransformType.GROUND)
        {
            mat.pushPose();
