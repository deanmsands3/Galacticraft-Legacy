...
{
    private static final EntityDataAccessor<Float> SPIN_PITCH = SynchedEntityData.defineId(EntitySmallAsteroid.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> SPIN_YAW = SynchedEntityData.defineId(EntitySmallAsteroid.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> ASTEROID_TYPE = SynchedEntityData.defineId(EntitySmallAsteroid.class, EntityDataSerializers.INT);
    public float spinPitch;
    public float spinYaw;
    public int type;
    private boolean firstUpdate = true;

    public EntitySmallAsteroid(EntityType<? extends EntitySmallAsteroid> type, Level worldIn)
    {
        super(type, worldIn);
