...
public class TileEntityMinerBaseRenderer extends TileEntityRenderer<TileEntityMinerBase>
{
    ...
    {
        minerBaseModelBaked = GCModelCache.INSTANCE.getModel(new ResourceLocation(GalacticraftPlanets.ASSET_PREFIX, "models/astro_miner_base.obj"), ImmutableList.of("dock"));
    }
