...
{
    public EntityTier3Rocket(EntityType<? extends EntityTier3Rocket> type, Level worldIn)
    {
        super(type, worldIn);
//        this.setSize(1.8F, 6.0F);
    }

    public static EntityTier3Rocket createEntityTier3Rocket(Level world, double x, double y, double z, EnumRocketType rocketType)
    {
