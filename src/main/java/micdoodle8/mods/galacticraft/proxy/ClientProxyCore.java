package micdoodle8.mods.galacticraft.proxy;
...
import micdoodle8.mods.galacticraft.blocks.BlockConcealedDetector;
import micdoodle8.mods.galacticraft.blocks.BlockConcealedRedstone;
import micdoodle8.mods.galacticraft.blocks.BlockConcealedRepeater;
import micdoodle8.mods.galacticraft.blocks.BlockEnclosed;
import micdoodle8.mods.galacticraft.blocks.BlockFallenMeteor;
import micdoodle8.mods.galacticraft.blocks.BlockGrating;
import micdoodle8.mods.galacticraft.blocks.BlockOxygenDetector;
import micdoodle8.mods.galacticraft.blocks.BlockPanelLighting;
import micdoodle8.mods.galacticraft.blocks.BlockSpaceGlass;
import micdoodle8.mods.galacticraft.client.DynamicTextureProper;
import micdoodle8.mods.galacticraft.client.EventHandlerClient;
import micdoodle8.mods.galacticraft.client.fx.EffectHandler;
import micdoodle8.mods.galacticraft.client.gui.screen.InventoryTabGalacticraft;
import micdoodle8.mods.galacticraft.client.model.ModelRocketTier1;
import micdoodle8.mods.galacticraft.client.model.OBJLoaderGC;
import micdoodle8.mods.galacticraft.client.model.block.ModelGrating;
import micdoodle8.mods.galacticraft.client.model.block.ModelPanelLightBase;
import micdoodle8.mods.galacticraft.client.render.entities.*;
import micdoodle8.mods.galacticraft.client.render.item.ItemModelBuggy;
import micdoodle8.mods.galacticraft.client.render.item.ItemModelFlag;
import micdoodle8.mods.galacticraft.client.render.item.ItemModelRocket;
import micdoodle8.mods.galacticraft.client.render.item.ItemModelWorkbench;
import micdoodle8.mods.galacticraft.client.render.item.TextureDungeonFinder;
import micdoodle8.mods.galacticraft.client.render.tile.*;
import micdoodle8.mods.galacticraft.client.sounds.GCSounds;
import micdoodle8.mods.galacticraft.client.sounds.MusicTickerGC;
import micdoodle8.mods.galacticraft.entities.*;
import micdoodle8.mods.galacticraft.entities.player.GCPlayerBaseSP;
import micdoodle8.mods.galacticraft.entities.player.IPlayerClient;
import micdoodle8.mods.galacticraft.entities.player.PlayerClient;
import micdoodle8.mods.galacticraft.fluid.FluidNetwork;
import micdoodle8.mods.galacticraft.init.GCBlocks;
import micdoodle8.mods.galacticraft.init.GCItems;
import micdoodle8.mods.galacticraft.inventory.InventoryExtended;
import micdoodle8.mods.galacticraft.items.ItemFood;
import micdoodle8.mods.galacticraft.items.ItemSchematic;
import micdoodle8.mods.galacticraft.network.PacketSimple;
import micdoodle8.mods.galacticraft.tick.KeyHandlerClient;
import micdoodle8.mods.galacticraft.tick.TickHandlerClient;
import micdoodle8.mods.galacticraft.tile.*;
import micdoodle8.mods.galacticraft.util.ClientUtil;
import micdoodle8.mods.galacticraft.util.CompatibilityManager;
...
import micdoodle8.mods.galacticraft.wrappers.BlockMetaList;
import micdoodle8.mods.galacticraft.wrappers.ModelTransformWrapper;
import micdoodle8.mods.galacticraft.wrappers.PartialCanister;
import micdoodle8.mods.galacticraft.wrappers.PlayerGearData;
...
//            ClientRegistry.bindTileEntitySpecialRenderer(TileEntityElectricIngotCompressor.class, new TileEntityMachineRenderer());
    ...
    private static void updateCapeList()
    {
        ...
        {
            GCLog.warn("Error getting capes list URL");
