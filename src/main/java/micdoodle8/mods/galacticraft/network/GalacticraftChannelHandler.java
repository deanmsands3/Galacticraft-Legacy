...
public class GalacticraftChannelHandler extends FMLIndexedMessageToMessageCodec<IPacket>
{
    ...
    public void sendToAllAround(IPacket message, NetworkRegistry.TargetPoint point)
    {
        ...
        {
            GCLog.warn("Forge error when sending network packet to nearby players - this is not a Galacticraft bug, does another mod make fake players?");
            e.printStackTrace();
        }
    }
    ...
    public void sendToDimension(IPacket message, int dimensionID)
    {
        ...
        {
            GCLog.warn("Forge error when sending network packet to all players in dimension - this is not a Galacticraft bug, does another mod make fake players?");
            e.printStackTrace();
        }
    }
