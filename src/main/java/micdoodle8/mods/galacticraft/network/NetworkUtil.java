...
import micdoodle8.mods.galacticraft.energy.tile.EnergyStorage;
import micdoodle8.mods.galacticraft.tile.FluidTankGC;
    ...
    public static void encodeData(ByteBuf buffer, Collection<Object> sendData) throws IOException
    {
        for (Object dataValue : sendData)
        {
            ...
            else
            {
                if (dataValue == null)
                {
                    GCLog.warn("Cannot construct PacketSimple with null data, this is a bug.");
                }
