package micdoodle8.mods.galacticraft.network;
...
import micdoodle8.mods.galacticraft.client.FootprintRenderer;
import micdoodle8.mods.galacticraft.client.fx.ParticleSparks;
import micdoodle8.mods.galacticraft.client.gui.GuiIdsCore;
import micdoodle8.mods.galacticraft.client.gui.container.GuiBuggy;
import micdoodle8.mods.galacticraft.client.gui.container.GuiParaChest;
import micdoodle8.mods.galacticraft.client.gui.screen.GuiCelestialSelection;
import micdoodle8.mods.galacticraft.client.sounds.GCSounds;
import micdoodle8.mods.galacticraft.command.CommandGCEnergyUnits;
import micdoodle8.mods.galacticraft.dimension.SpaceRace;
import micdoodle8.mods.galacticraft.dimension.SpaceRaceManager;
import micdoodle8.mods.galacticraft.dimension.SpaceStationWorldData;
import micdoodle8.mods.galacticraft.dimension.WorldProviderSpaceStation;
import micdoodle8.mods.galacticraft.energy.tile.TileBaseConductor;
import micdoodle8.mods.galacticraft.entities.EntityBuggy;
import micdoodle8.mods.galacticraft.entities.EntityHangingSchematic;
import micdoodle8.mods.galacticraft.entities.IBubbleProvider;
import micdoodle8.mods.galacticraft.entities.IControllableEntity;
import micdoodle8.mods.galacticraft.entities.player.*;
...
import micdoodle8.mods.galacticraft.inventory.IInventorySettable;
import micdoodle8.mods.galacticraft.items.ItemParaChute;
...
import micdoodle8.mods.galacticraft.wrappers.FlagData;
import micdoodle8.mods.galacticraft.wrappers.Footprint;
import micdoodle8.mods.galacticraft.wrappers.PlayerGearData;
import micdoodle8.mods.galacticraft.wrappers.ScheduledDimensionChange;
...
public class PacketSimple extends PacketBase implements Packet<INetHandler>
{
    ...
    public void decodeInto(ByteBuf buffer)
    {
        ...
        try
        {
            ...
            {
                GCLog.warn("Galacticraft packet length problem for packet type " + this.type.toString());
            }
        }
        catch (Exception e)
        {
...
//                player.world.getBlockState(tile.getPos()).getBlock().setBlockBoundsBasedOnState(player.world, tile.getPos()); TODO
    ...
    public void handleServerSide(EntityPlayer player)
    {
        ...
        case S_REQUEST_MAP_IMAGE:
            ...
            MapUtil.sendOrCreateMap(world, cx, cz, playerBase);
            break;
