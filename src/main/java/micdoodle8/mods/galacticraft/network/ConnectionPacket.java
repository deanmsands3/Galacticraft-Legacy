...
public class ConnectionPacket
{
    ...
    public void handle(ByteBuf payload, EntityPlayer player)
    {
        ...
        {
            GCLog.warn("Packet completion problem for connection packet " + packetId + " - maybe the player's Galacticraft version does not match the server version?");
        }
    }
    ...
    public void onFMLProxyPacketData(NetworkManager manager, FMLProxyPacket packet, EntityPlayer player)
    {
        ...
        {
            GCLog.warn("GC login packet handler: Failed to read packet");
            GCLog.warn(e.toString());
            e.printStackTrace();
        }
    }
}
