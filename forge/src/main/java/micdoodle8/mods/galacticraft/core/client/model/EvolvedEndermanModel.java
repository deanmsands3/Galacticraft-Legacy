...
@OnlyIn(Dist.CLIENT)
public class EvolvedEndermanModel extends BipedModel<EvolvedEndermanEntity>
{
    ...
    @Override
    public void setRotationAngles(EvolvedEndermanEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    ...
    protected Iterable<ModelRenderer> getBodyParts() {
        return ImmutableList.of(this.bipedBody, this.bipedRightArm, this.bipedLeftArm, this.bipedRightLeg, this.bipedLeftLeg, this.bipedHeadwear, oxygenMask, tank1, tank2, tube1, tube2, tube3, tube4, tube5, tube6, tube7, tube8, tube9, tube10, tube11, tube12, tube13, tube14);
    }
}