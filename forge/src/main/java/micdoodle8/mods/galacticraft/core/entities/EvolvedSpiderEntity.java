...
public class EvolvedSpiderEntity extends Spider implements IEntityBreathable
{
    public EvolvedSpiderEntity(EntityType<? extends EvolvedSpiderEntity> type, Level world)
    {
        super(type, world);
    }
    ...
    public SpawnGroupData finalizeSpawn(LevelAccessor worldIn, DifficultyInstance difficultyIn, MobSpawnType reason, @Nullable SpawnGroupData spawnDataIn, @Nullable CompoundTag dataTag)
    {
        ...
        {
            EvolvedSkeletonEntity entityskeleton = new EvolvedSkeletonEntity(GCEntities.EVOLVED_SKELETON, level);
