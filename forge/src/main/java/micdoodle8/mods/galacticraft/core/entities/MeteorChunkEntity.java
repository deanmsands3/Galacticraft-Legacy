...
public class MeteorChunkEntity extends Entity implements Projectile
{
    private static final EntityDataAccessor<Boolean> IS_HOT = SynchedEntityData.defineId(MeteorChunkEntity.class, EntityDataSerializers.BOOLEAN);
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    @Nullable
    ...
    public MeteorChunkEntity(EntityType<MeteorChunkEntity> type, Level world)
    {
        super(type, world);
    ...
    public MeteorChunkEntity(Level world, LivingEntity par2EntityLivingBase, float speed)
    {
...
//            this.motionZ *= f4;
    ...
    public void playerTouch(Player par1EntityPlayer)
    {
        if (!this.level.isClientSide && this.inGround)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.add(new ItemStack(GCItems.METEOR_CHUNK, 1)))
            {
                flag = false;
            }
