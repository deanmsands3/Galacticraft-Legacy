...
public class EvolvedSkeletonBossModel extends EntityModel<EvolvedSkeletonBossEntity>
{
    ...
    public EvolvedSkeletonBossModel()
    {
        this.texWidth = 128;
        this.texHeight = 128;
    ...
    @Override
    public void setRotationAngles(EvolvedSkeletonBossEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
...
//        }
        ...
        if (this.attackTime > -9990.0F)
        {
            ...
            this.spine.yRot = Mth.sin(Mth.sqrt(var7) * Constants.twoPI) * 0.2F;
