...
public class GuiGeothermal extends GuiContainerGC<ContainerGeothermal>
{
    ...
    public GuiGeothermal(ContainerGeothermal container, Inventory playerInv, Component title)
    {
...
//        this.infoRegions.add(new GuiElementInfoRegion((this.width - this.xSize) / 2 + 47, (this.height - this.ySize) / 2 + 20, 18, 18, sunGenDesc, this.width, this.height, this));
        ...
        {
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, GCCoreUtil.getDimensionType(this.minecraft.level), new Object[]{this.geothermalGenerator.getBlockPos(), 0}));
        }));
    }
...
//        this.font.drawString(displayString, this.xSize / 2 - this.font.getStringWidth(displayString) / 2, 56 + 23 - 46 + offsetY, 4210752);
    ...
    protected void renderBg(float var1, int var2, int var3)
    {
        ...
        this.minecraft.getTextureManager().bind(GuiGeothermal.backgroundTexture);
