...
//        GalacticraftCore.packetPipeline.addDiscriminator(6, PacketSimpleMars.class);
        ...
        MarsModule.planetMars.addMobInfo(new Biome.SpawnerData(GCEntities.EVOLVED_ZOMBIE, 8, 2, 3), EntityClassification.MONSTER);
        MarsModule.planetMars.addMobInfo(new Biome.SpawnerData(GCEntities.EVOLVED_SPIDER, 8, 2, 3), EntityClassification.MONSTER);
        MarsModule.planetMars.addMobInfo(new Biome.SpawnerData(GCEntities.EVOLVED_SKELETON, 8, 2, 3), EntityClassification.MONSTER);
        MarsModule.planetMars.addMobInfo(new Biome.SpawnerData(GCEntities.EVOLVED_CREEPER, 8, 2, 3), EntityClassification.MONSTER);
        MarsModule.planetMars.addMobInfo(new Biome.SpawnerData(GCEntities.EVOLVED_ENDERMAN, 10, 1, 4), EntityClassification.MONSTER);
