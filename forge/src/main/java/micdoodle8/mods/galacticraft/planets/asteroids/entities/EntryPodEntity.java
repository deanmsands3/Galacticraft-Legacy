...
{
    public EntryPodEntity(EntityType<? extends EntryPodEntity> type, Level worldIn)
    {
        super(type, worldIn);
//        this.setSize(1.5F, 3.0F);
    }

    public static EntryPodEntity createEntityEntryPod(ServerPlayer player)
    {
        EntryPodEntity pod = new EntryPodEntity(AsteroidEntities.ENTRY_POD, player.level);
...
//    }
    ...
    public void onGroundHit()
    {
        ...
        this.level.setBlock(pos, GCBlocks.BRIGHT_AIR.defaultBlockState(), 2);
    }
