...
public class AsteroidsContainers
{
    ...
    public static void initContainers(RegistryEvent.Register<MenuType<?>> evt)
    {
        ...
        MenuType<ContainerAstroMinerDock> minerDock = IForgeContainerType.create((windowId, inv, data) -> new ContainerAstroMinerDock(windowId, inv, (TileEntityMinerBase) inv.player.world.getTileEntity(data.readBlockPos())));
        ...
        MenuType<ContainerShortRangeTelepad> telepad = IForgeContainerType.create((windowId, inv, data) -> new ContainerShortRangeTelepad(windowId, inv, (TileEntityShortRangeTelepad) inv.player.world.getTileEntity(data.readBlockPos())));
