...
public class SlimelingRenderer extends MobRenderer<SlimelingEntity, SlimelingModel>
{
    ...
    public SlimelingRenderer(EntityRenderDispatcher renderManager)
    {
    ...
    @Override
    protected void preRenderCallback(SlimelingEntity entity, PoseStack matrixStack, float partialTickTime)
    {
        matrixStack.mulPose(Vector3f.YP.rotation(180.0F));
    ...
    @Override
    public void render(SlimelingEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight)
    {
