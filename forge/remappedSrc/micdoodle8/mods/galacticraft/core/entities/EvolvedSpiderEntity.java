...
public class EvolvedSpiderEntity extends SpiderEntity implements IEntityBreathable
{
    public EvolvedSpiderEntity(EntityType<? extends EvolvedSpiderEntity> type, World world)
    {
        super(type, world);
    }
    ...
    public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag)
    {
        ...
        {
            EvolvedSkeletonEntity entityskeleton = new EvolvedSkeletonEntity(GCEntities.EVOLVED_SKELETON, world);
