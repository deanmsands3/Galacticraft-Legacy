...
public class MeteorChunkEntity extends Entity implements IProjectile
{
    private static final DataParameter<Boolean> IS_HOT = EntityDataManager.createKey(MeteorChunkEntity.class, DataSerializers.BOOLEAN);
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    @Nullable
    ...
    public MeteorChunkEntity(EntityType<MeteorChunkEntity> type, World world)
    {
        super(type, world);
    ...
    public MeteorChunkEntity(World world, LivingEntity par2EntityLivingBase, float speed)
    {
