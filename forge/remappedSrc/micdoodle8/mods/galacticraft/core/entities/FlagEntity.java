...
{
    private static final DataParameter<String> OWNER = EntityDataManager.createKey(FlagEntity.class, DataSerializers.STRING);
    private static final DataParameter<Float> DAMAGE = EntityDataManager.createKey(FlagEntity.class, DataSerializers.FLOAT);
    private static final DataParameter<Integer> FACING_ANGLE = EntityDataManager.createKey(FlagEntity.class, DataSerializers.VARINT);
    ...
    public FlagEntity(EntityType<FlagEntity> type, World world)
    {
        super(type, world);
        this.ignoreFrustumCheck = true;
    }

    public FlagEntity(World world, double x, double y, double z, int dir)
    {
