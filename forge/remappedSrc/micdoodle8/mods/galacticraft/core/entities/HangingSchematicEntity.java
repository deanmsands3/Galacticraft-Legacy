...
public class HangingSchematicEntity extends HangingEntity
{
    ...
    protected HangingSchematicEntity(EntityType<? extends HangingSchematicEntity> type, World world)
    {
        super(type, world);
    }

    public HangingSchematicEntity(EntityType<? extends HangingSchematicEntity> type, World world, BlockPos pos, Direction facing, int schematicType)
    {
        super(type, world);
