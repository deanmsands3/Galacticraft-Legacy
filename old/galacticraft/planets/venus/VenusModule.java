...
//        this.registerOtherEntities();
        ...
        VenusModule.planetVenus.addMobInfo(new SpawnerData(GCEntities.EVOLVED_ZOMBIE, 8, 2, 3), EntityClassification.MONSTER);
        VenusModule.planetVenus.addMobInfo(new SpawnerData(GCEntities.EVOLVED_SPIDER, 8, 2, 3), EntityClassification.MONSTER);
        VenusModule.planetVenus.addMobInfo(new SpawnerData(GCEntities.EVOLVED_SKELETON, 8, 2, 3), EntityClassification.MONSTER);
        VenusModule.planetVenus.addMobInfo(new SpawnerData(GCEntities.EVOLVED_CREEPER, 8, 2, 3), EntityClassification.MONSTER);
        VenusModule.planetVenus.addMobInfo(new SpawnerData(GCEntities.EVOLVED_ENDERMAN, 10, 1, 4), EntityClassification.MONSTER);
