...
public abstract class PieceVenus extends StructurePiece
{
    ...
    public PieceVenus(StructurePieceType type)
    {
        super(type, 0);
    }

    public PieceVenus(StructurePieceType type, DungeonConfigurationVenus configuration)
    {
        this(type);
        this.configuration = configuration;
    }

    public PieceVenus(StructurePieceType type, CompoundTag tagCompound)
    {
