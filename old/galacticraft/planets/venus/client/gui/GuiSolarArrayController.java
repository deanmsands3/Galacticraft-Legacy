...
public class GuiSolarArrayController extends GuiContainerGC<ContainerSolarArrayController>
{
    ...
    public GuiSolarArrayController(ContainerSolarArrayController container, Inventory playerInv, Component title)
    {
    ...
    public void init()
    {
        ...
        this.infoRegions.add(new GuiElementInfoRegion((this.width - this.imageWidth) / 2 + 151, (this.height - this.imageHeight) / 2 + 90, 18, 18, batterySlotDesc, this.width, this.height, this));
        ...
        {
            GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, GCCoreUtil.getDimensionType(this.minecraft.level), new Object[]{this.solarController.getBlockPos(), 0}));
        }));
    }
    ...
    protected void renderLabels(int par1, int par2)
    {
        ...
        this.font.draw(displayString, this.imageWidth / 2 - this.font.width(displayString) / 2, 45 + 23 - 46 + offsetY, 4210752);
        ...
        this.font.draw(displayString, this.imageWidth / 2 - this.font.width(displayString) / 2, 34 + 23 - 46 + offsetY, 4210752);
        ...
        this.font.draw(displayString, this.imageWidth / 2 - this.font.width(displayString) / 2, 56 + 23 - 46 + offsetY, 4210752);
        ...
        this.font.draw(displayString, this.imageWidth / 2 - this.font.width(displayString) / 2, 67 + 23 - 46 + offsetY, 4210752);
    ...
    private String getStatus()
    {
        ...
        if (!this.solarController.getLevel().isDay())
        {
            return EnumColor.DARK_RED + GCCoreUtil.translate("gui.status.blockedfully");
        }

        if (this.solarController.getLevel().isRaining() || this.solarController.getLevel().isThundering())
        {
    ...
    protected void renderBg(float var1, int var2, int var3)
    {
        ...
        this.minecraft.getTextureManager().bind(GuiSolarArrayController.solarGuiTexture);
