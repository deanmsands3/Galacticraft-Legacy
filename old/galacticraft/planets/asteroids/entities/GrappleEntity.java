...
public class GrappleEntity extends Entity implements Projectile
{
    private static final EntityDataAccessor<Integer> PULLING_ENTITY_ID = SynchedEntityData.defineId(GrappleEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> IS_PULLING = SynchedEntityData.defineId(GrappleEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<ItemStack> STRING_ITEM_STACK = SynchedEntityData.defineId(GrappleEntity.class, EntityDataSerializers.ITEM_STACK);
    ...
    public GrappleEntity(EntityType<? extends GrappleEntity> type, Level worldIn)
    {
        super(type, worldIn);
...
//        this.setSize(0.75F, 0.75F);
    ...
    public static GrappleEntity createEntityGrapple(Level world, Player shootingEntity, float par3, ItemStack stringStack)
    {
...
//                            stats.getFreefallHandler().updateFreefall(shootingEntity); TODO Freefall
        ...
        else
        {
            ...
            if (castResult.getType() == RayTraceResult.Type.ENTITY && ((EntityHitResult) castResult).getEntity() instanceof Player)
            {
