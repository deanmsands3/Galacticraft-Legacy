...
public class ContainerSchematicTier2Rocket extends AbstractContainerMenu
{
    @ObjectHolder(Constants.MOD_ID_PLANETS + ":" + MarsContainerNames.SCHEMATIC_T2_ROCKET)
    public static MenuType<ContainerSchematicTier2Rocket> TYPE;
    ...
    public ContainerSchematicTier2Rocket(int containerId, Inventory playerInv)
    {
    ...
    {
        this.craftResult.setItem(0, RecipeUtilMars.findMatchingSpaceshipT2Recipe(this.craftMatrix));
    }
...
//                    } TODO Oredictionary
                    if (foundChest)
                    {
                        ...
                        else if (!this.slots.get(20).hasItem())
                        {
                        ...
                        else if (!this.slots.get(21).hasItem())
                        {
