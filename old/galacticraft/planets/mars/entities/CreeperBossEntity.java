...
public class CreeperBossEntity extends EntityBossBase implements IEntityBreathable, RangedAttackMob
{
    protected long ticks = 0;
    public int headsRemaining = 3;
    private Entity targetEntity;

    public CreeperBossEntity(EntityType<? extends CreeperBossEntity> type, Level worldIn)
    {
        super(type, worldIn);
...
//        this.isImmuneToFire = true;
    ...
    public static CreeperBossEntity create(Level world)
    {
...
//    } TODO Item drops
    ...
    public void performRangedAttack(LivingEntity entitylivingbase, float f)
    {
        ...
        TNTProjectileEntity projectileTNT = TNTProjectileEntity.createEntityProjectileTNT(this.level, this, d6 * 0.5D, d7 * 0.5D, d8 * 0.5D);
    ...
    public void dropKey()
    {
        this.spawnAtLocation(new ItemStack(MarsItems.TIER_2_DUNGEON_KEY, 1), 0.5F);
    }
