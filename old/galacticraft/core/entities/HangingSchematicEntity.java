...
public class HangingSchematicEntity extends HangingEntity
{
    public int schematic;
    private boolean sendToClient;
    private int tickCounter1;

    protected HangingSchematicEntity(EntityType<? extends HangingSchematicEntity> type, Level world)
    {
        super(type, world);
    }

    public HangingSchematicEntity(EntityType<? extends HangingSchematicEntity> type, Level world, BlockPos pos, Direction facing, int schematicType)
    {
        super(type, world);
