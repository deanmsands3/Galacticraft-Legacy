...
//        super(new ContainerFuelLoader(playerInv, fuelLoader), playerInv, new TranslationTextComponent("container.fuel_loader"));
    ...
    protected void renderLabels(int par1, int par2)
    {
        ...
        this.font.draw(GCCoreUtil.translate("gui.message.status") + ": " + this.getStatus(), 28, 45 + 23 - 46, 4210752);
        ...
        this.font.draw(GCCoreUtil.translate("container.inventory"), 8, this.imageHeight - 118 + 2 + 11, 4210752);
    }
